...
const date = new Date()
const getDay = () => { return date.getDate().toString().padStart(2, '0') }
const getMonth = () => { return (date.getMonth()+1).toString().padStart(2, '0') }
const getYear = () => { return date.getFullYear() }
